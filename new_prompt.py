...
VALIDATION_PROMPT = PromptTemplate(
    input_variables=["context", "source_db", "target_db", "transformation_logic", "query"],
    template="""You are a senior MySQL ETL validation engineer. Create comprehensive validation queries that thoroughly test the ETL process.
...
-- PRE-VALIDATION: Schema and connectivity checks
-- ============================================================================
[Generate schema validation queries]

-- CORE VALIDATION: Data integrity and quality
-- ============================================================================
[Generate comprehensive data validation queries]

-- POST-VALIDATION: Analysis and reporting
-- ============================================================================
[Generate analysis and reporting queries]

-- RECONCILIATION: Summary and recommendations
-- ============================================================================
